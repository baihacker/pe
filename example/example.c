...
void LinearRecurrenceExample() {
...

  {
    ...
    std::cout << *FindLinearRecurrenceValueAt({1, 2, 4, 8, 16, 32, 64}, 7, mod)
              << std::endl;
    std::cout << *FindLinearRecurrenceValueAt({1, 1, 2, 3, 5, 8, 13},
                                              10000000000, mod)
              << std::endl;
  }
  {
    ...
    for (int i = 2; i <= 5; ++i) {
      std::cout << LinearRecurrenceValueAt(rec, init, i, mod) << std::endl;
    }
  }
  {
    std::vector<int64> rec = {mod - 1, mod - 1, 1};
    std::vector<int64> init = {1, 1};
    for (int i = 0; i <= 5; ++i) {
      std::cout << LinearRecurrenceSumAt(rec, init, i, mod) << std::endl;
    }
  }
}
