...
const int32 ValueHolder<int32>::values[] {
  -2147483647, -1073741824, -1, 0, 1, 1073741824, 2147483647
};
const int32 ValueHolder<int32>::mods[] = {
...
const uint32 ValueHolder<uint32>::values[] {
  0u, 1u, 2147483648u, 4294967295u
};
const uint32 ValueHolder<uint32>::mods[] {
  1u, 2147483648u, 4294967295u
};
...
const int64 ValueHolder<int64>::values[] {
  -9223372036854775807ll, -4611686018427387904ll, -2147483647ll, -1073741824ll, -1ll, 0ll, 1ll, 1073741824ll, 2147483647ll, 4611686018427387904ll, 9223372036854775807ll
};
const int64 ValueHolder<int64>::mods[] {
  1ll, 1073741824ll, 2147483647ll, 4611686018427387904ll, 9223372036854775807ll
};
...
const uint64 ValueHolder<uint64>::values[] {
  0u, 1ull, 2147483648ull, 2147483647ull, 9223372036854775807ull, 18446744073709551615ull
};
const uint64 ValueHolder<uint64>::mods[] {
  1ull, 2147483648ull, 2147483647ull, 9223372036854775807ull, 18446744073709551615ull
};
